...
\begin{enumerate}[leftmargin=80pt]
    \item \textbf{Portable menu and stalls guidebook:} A collection of menu items and stalls offering them right at the fingertips,
    it boasts in user accessibility and speed of data retrieval.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{kueater/timeline.png}
